...
class _IndexStackExState extends State<IndexStackEx> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    animation = Tween(begin: Offset(1, 0), end: Offset(0.0, 0)).chain(CurveTween(curve: Curves.easeOutQuint)).animate(_animationController);
//    animation = Tween(begin: 0.0, end: 1.0).animate(_animationController);
  ...
  Widget bottomButtons() {
    return Container(
      ...
      decoration: BoxDecoration(color: Color(0xFFFFEBEE), borderRadius: BorderRadius.all(Radius.circular(35.0)), border: Border.all(width: 1, color: Color(0xFFEF9A9A))),
      child: Center(
        child: Stack(
          children: <Widget>[
            Container(

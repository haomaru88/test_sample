      ...
      body: ListView(
        ...
        children: [
          _OpenContainerWrapper(
            ...
            closedBuilder: (context, openContainer) => _DetailsCard(openContainer: openContainer),
          ),
          const SizedBox(height: 16),
          _OpenContainerWrapper(
            transitionType: transitionType,
            closedBuilder: (context, openContainer) => _DetailsListTile(openContainer: openContainer),
          ),
          const SizedBox(height: 16),
          getFirstRow(),
          const SizedBox(height: 16),
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              ...
              style: Theme.of(context).textTheme.bodyMedium!.copyWith(color: Colors.black54, inherit: false),
            ),
          ),
        ],
      ),
          ...
          Expanded(
            child: Padding(
              ...
              child: Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('제목', style: textTheme.titleLarge),
          ...
          Expanded(
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('제목', style: textTheme.titleMedium),

...
class ChatState extends State<Chat> {
  ...
  Widget renderListView() {
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        return (sender == widget.user) ? renderSendMessage('@$time $msg') : renderReturnMessage('$sender @$time $msg');
      },
    );
  }
  ...
  void _sendMessage() {
    ...
    if (messageText != '') {
      var messagePost = {'message': messageText, 'sender': widget.user, 'recipient': 'chat', 'time': DateTime.now().toUtc().toString().substring(0, 16)};

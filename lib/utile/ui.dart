...
Widget renderTextField(TextEditingController tec, String title, String hint, bool obscure) {
  return Container(
    height: 45,
...
BoxDecoration getBorderBox() {
  return BoxDecoration(color: Colors.white, border: Border.all(width: 1, color: Colors.black12));
}
  ...
  return TextButton(
    ...
    child: Ink(
      decoration: BoxDecoration(
          gradient: LinearGradient(colors: <Color>[buttonColor, buttonLightColor]), borderRadius: BorderRadius.all(Radius.circular(80.0)), border: Border.all(width: 1, color: Colors.black12)),
      child: Container(

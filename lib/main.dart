...
import 'package:navigator/animation/33_musinsa_list.dart';
...
final animation = [
  MyRouts(name: 'AnimatedContainer', route: AnimatedContainerDemo.routeName, builder: (context) => AnimatedContainerDemo()),
  MyRouts(name: 'PageRouteBuilder', route: PageRouteBuilderDemo.routeName, builder: (context) => PageRouteBuilderDemo()),
  MyRouts(name: 'Animation Controller', route: AnimationControllerDemo.routeName, builder: (context) => AnimationControllerDemo()),
  MyRouts(name: 'Tweens', route: TweenDemo.routeName, builder: (context) => TweenDemo()),
  MyRouts(name: 'AnimatedBuilder', route: AnimatedBuilderDemo.routeName, builder: (context) => AnimatedBuilderDemo()),
  MyRouts(name: 'Custom Tween', route: CustomTweenDemo.routeName, builder: (context) => CustomTweenDemo()),
  MyRouts(name: 'Tween Sequences', route: TweenSequenceDemo.routeName, builder: (context) => TweenSequenceDemo()),
  MyRouts(name: 'Tween builder', route: TweenBuilderDemo.routeName, builder: (context) => TweenBuilderDemo()),
  MyRouts(name: 'Rotation Transition', route: TimeMachineDemo.routeName, builder: (context) => TimeMachineDemo()),
  MyRouts(name: 'Animated Widget', route: MyHomePage.routeName, builder: (context) => MyHomePage()),
  MyRouts(name: 'Basic Animation', route: BasicAnimationDemo.routeName, builder: (context) => BasicAnimationDemo()),
  MyRouts(name: 'Fade Transition', route: FadeTransitionDemo.routeName, builder: (context) => FadeTransitionDemo()),
  MyRouts(name: 'Expandable Card', route: ExpandCardDemo.routeName, builder: (context) => ExpandCardDemo()),
  MyRouts(name: 'Carousel', route: CarouselDemo.routeName, builder: (context) => CarouselDemo()),
  MyRouts(name: 'Focus Image', route: FocusImageDemo.routeName, builder: (context) => FocusImageDemo()),
  MyRouts(name: 'Card Swipe', route: CardSwipeDemo.routeName, builder: (context) => CardSwipeDemo()),
  MyRouts(name: 'Repeating Animation', route: RepeatingAnimationDemo.routeName, builder: (context) => RepeatingAnimationDemo()),
  MyRouts(name: 'Spring Physics', route: PhysicsCardDragDemo.routeName, builder: (context) => PhysicsCardDragDemo()),
  MyRouts(name: 'Page View Fade', route: PageViewFade.routeName, builder: (context) => PageViewFade()),
  MyRouts(name: 'Fade Out Route', route: FadeOutRoute.routeName, builder: (context) => FadeOutRoute()),
  MyRouts(name: 'Backdrop', route: BackdropExample.routeName, builder: (context) => BackdropExample()),
  MyRouts(
  ...
  MyRouts(
    ...
    builder: (BuildContext context) => const ExpansionViewExample(),
  ),
  MyRouts(
    name: 'Musinsa List Example',
    route: MusinsaListExample.routeName,
    builder: (BuildContext context) => MusinsaListExample(),
  ),
];
...
final examples = [
  ...
  MyRouts(
    ...
    builder: (BuildContext context) => const OpenContainerTransformDemo(),
  ),
  MyRouts(
    name: 'TextField',
  ...
  MyRouts(
    ...
    builder: (BuildContext context) => const ImageCropView(),
  ),
  MyRouts(
    name: 'Image Rotate View',
    route: ImageRotateView.routeName,
    builder: (BuildContext context) => const ImageRotateView(),
  ),
  MyRouts(
    name: 'Nesting Routes',
...
final weekOfWidgets = [
  MyRouts(name: 'Custom Paint', route: CustomPaintEx.routeName, builder: (BuildContext context) => CustomPaintEx()),
  MyRouts(name: 'Backdrop Filter', route: BackdropFilterEx.routeName, builder: (BuildContext context) => BackdropFilterEx()),
  MyRouts(name: 'Dismissible', route: DismissibleEx.routeName, builder: (BuildContext context) => DismissibleEx()),
  MyRouts(
  ...
  MyRouts(name: 'SliverEx', route: SliverEx.routeName, builder: (BuildContext context) => SliverEx()),
  MyRouts(name: 'SliverListGridEx', route: SliverListGridEx.routeName, builder: (BuildContext context) => SliverListGridEx()),
  MyRouts(name: 'DraggableEx', route: DraggableEx.routeName, builder: (BuildContext context) => DraggableEx()),
  MyRouts(name: 'AnimatedListSample', route: AnimatedListSample.routeName, builder: (BuildContext context) => AnimatedListSample()),
  MyRouts(name: 'AnimatedIconEx', route: AnimatedIconEx.routeName, builder: (BuildContext context) => AnimatedIconEx()),
  MyRouts(name: 'ReorderListViewEx', route: ReorderListViewEx.routeName, builder: (BuildContext context) => ReorderListViewEx()),
  MyRouts(name: 'AnimatedSwitcher', route: AnimatedSwitcherEx.routeName, builder: (BuildContext context) => AnimatedSwitcherEx()),
  MyRouts(name: 'IndexStack', route: IndexStackEx.routeName, builder: (BuildContext context) => IndexStackEx()),
  MyRouts(name: 'Stack', route: StackEx.routeName, builder: (BuildContext context) => StackEx()),
  MyRouts(name: 'DraggableScrollableSheet', route: DraggableScrollableSheetEx.routeName, builder: (BuildContext context) => DraggableScrollableSheetEx()),
  MyRouts(name: 'animated_list_example', route: AnimatedListExample.routeName, builder: (BuildContext context) => AnimatedListExample()),
  MyRouts(name: 'nested_scroll_view', route: NestedScrollViewExample.routeName, builder: (BuildContext context) => NestedScrollViewExample()),
  MyRouts(name: 'layout_example', route: LayoutExample.routeName, builder: (BuildContext context) => LayoutExample()),
  MyRouts(name: 'async_example', route: AsyncExample.routeName, builder: (BuildContext context) => AsyncExample()),
];

final boxConstraints = [
  MyRouts(name: 'Box Constraint', route: BoxConstraintEx.routeName, builder: (BuildContext context) => BoxConstraintEx()),
];

final animationMap = Map.fromEntries(animation.map((MyRouts item) => MapEntry(item.route, item.builder)));

final examplesMap = Map.fromEntries(examples.map((MyRouts item) => MapEntry(item.route, item.builder)));

final weekOfWidgetMap = Map.fromEntries(weekOfWidgets.map((MyRouts item) => MapEntry(item.route, item.builder)));

final boxConstraintMap = Map.fromEntries(boxConstraints.map((MyRouts item) => MapEntry(item.route, item.builder)));
